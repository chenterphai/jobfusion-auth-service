...
```bash
python3 -m grpc_tools.protoc -I=src/server/proto --python_out=src/server/grpc --grpc_python_out=src/server/grpc src/server/proto/user.proto
```